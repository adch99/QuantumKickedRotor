...
\sqrt{13}$ and the momentum basis is from -10 to 10. We consider a
...
For large K values, the system nicely fits into the poisson distribution.
...
the \[0.9, 1.1\] range](img/quasiperiodic_kickedrotor_spectrum_N10_metallic.pdf){ height=60% .center}

---------------------------------------------------------------------

## Results (cont.)

At critical point, things seem okay, but there is a noticeable
difference at zero.

![Critical: $K = 6.36$, $\alpha = 0.4375$ with 7874 eigenphases.
No degeneracy, buy 1387 phases were discarded for being out of
range.](img/quasiperiodic_kickedrotor_spectrum_N10_critical.pdf){ height=60% .center}

---------------------------------------------------------------------

## Results (cont.)

For small K values, things get weird...

![Pre-critical (Insulator): $K = 4$, $\alpha = 0.1$ with 8379
eigenphases. No degeneracy, but 882 phases were discarded for
being out of range.](img/quasiperiodic_kickedrotor_spectrum_N10_insulator.pdf){ height=60% .center }
